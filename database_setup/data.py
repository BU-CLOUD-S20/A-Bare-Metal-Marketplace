...
# start_time_l = [2020, 6, 1, 10, 0]
# end_time_l = [2020, 6, 2, 12, 0]
# status = "available"
# cost = 7
# provider_id = "p1"
# renter_id = "r1"
...
#                     'status': status, 'cost': cost, 'provider_id': provider_id, 'renter_id': renter_id}
#
# res = requests.post("http://127.0.0.1:5001/run_transaction", data=json.dumps(data),
#                     headers={'Content-Type': 'application/json'})
# r_json = res.json()
# print(r_json.get("flag", False))

# offer0 = {'offer_id': 'o1', 'project_id': 'p1', 'status': 'available', 'resource_id': '67d9726d-96f3-4088-8371-aeea62da6795', 'start_time': datetime(2020, 6, 2, 10, 00), 'end_time': datetime(2020, 6, 2, 12, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 20}
# offer1 = {'offer_id': 'o2', 'project_id': 'p1', 'status': 'available', 'resource_id': '82ea2350-ff60-43f0-881f-3b7b9fdbd7c6', 'start_time': datetime(2020, 6, 2, 13, 00), 'end_time': datetime(2020, 6, 2, 20, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 5}
# offers = [offer0, offer1]
#
# bid0 = {'bid_id': 'b1', 'project_id': 'r1', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 10, 00), 'end_time': datetime(2020, 6, 2, 12, 00), 'expire_time': datetime(2020, 5, 1, 1, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 20}
# bid1 = {'bid_id': 'b2', 'project_id': 'r1', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 13, 00), 'end_time': datetime(2020, 6, 2, 17, 00), 'expire_time': datetime(2020, 5, 1, 2, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 10}
# bids = [bid0, bid1]
#
# provider0 = {'user_id': 'p1', 'username': 'provider0', 'role': 'provider', 'credit': 100}
# renter0 = {'user_id': 'r1', 'username': 'provider0', 'role': 'provider', 'credit': 100}
# users = [provider0, renter0]
offer0 = {'offer_id': '0ee67a67-f8e2-4db0-be81-fa9579f3ebd0', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': '67d9726d-96f3-4088-8371-aeea62da6795', 'start_time': datetime(2020, 6, 2, 8, 00), 'end_time': datetime(2020, 6, 2, 12, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 10}
offer1 = {'offer_id': '08d727a9-485a-4bf8-82e0-ee5f724e2020', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': '82ea2350-ff60-43f0-881f-3b7b9fdbd7c6', 'start_time': datetime(2020, 6, 2, 10, 00), 'end_time': datetime(2020, 6, 2, 12, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 20}
offer2 = {'offer_id': '4b29b725-b20c-43c9-8d5e-c52ab8292ff3', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': 'a1776463-664b-4cf2-ba8a-891870ead78d', 'start_time': datetime(2020, 6, 2, 12, 00), 'end_time': datetime(2020, 6, 2, 14, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 15}
offer3 = {'offer_id': '32f51886-44c7-4df0-849c-95b25426a524', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': '8c127ab1-27d3-40f1-ac1b-09500156e0dc', 'start_time': datetime(2020, 6, 2, 12, 00), 'end_time': datetime(2020, 6, 2, 16, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 12}
offer4 = {'offer_id': 'c4e9b878-61ee-4b07-9218-fa94c2bf6348', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': 'e0c18d09-6275-4d12-a9f1-74df71fa09c3', 'start_time': datetime(2020, 6, 2, 12, 00), 'end_time': datetime(2020, 6, 2, 18, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 15}
offer5 = {'offer_id': 'fa571588-7a9e-45d7-9a53-a869c00ce42a', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': '56d78001-f8d7-4a51-baee-3af6c685aebc', 'start_time': datetime(2020, 6, 2, 14, 00), 'end_time': datetime(2020, 6, 2, 16, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 17}
offer6 = {'offer_id': '89b5de49-12c3-439b-be09-4e75454b94f4', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': 'cef6d2cb-cd28-45b3-97ed-59deb61a436a', 'start_time': datetime(2020, 6, 2, 12, 00), 'end_time': datetime(2020, 6, 2, 16, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 19}
offer7 = {'offer_id': 'e185a350-5078-48fa-8488-584caa8e23fb', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': '59b397a0-f863-44a3-8ee7-59e4e3473c8a', 'start_time': datetime(2020, 6, 2, 16, 00), 'end_time': datetime(2020, 6, 2, 20, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 12}
offer8 = {'offer_id': 'b235f398-368e-4059-b556-2bfbf15cf01f', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': 'a2798b5d-8ec2-43a2-9e6f-297b8f9ed3ef', 'start_time': datetime(2020, 6, 2, 20, 00), 'end_time': datetime(2020, 6, 2, 23, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 15}
offer9 = {'offer_id': '0921d243-3088-4662-9e9f-75087e4c18e7', 'project_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'status': 'available', 'resource_id': 'e17d37c8-385a-47c3-9dd6-fbd168b81728', 'start_time': datetime(2020, 6, 2, 20, 00), 'end_time': datetime(2020, 6, 2, 22, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'config': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 17}
offers = [offer0, offer1, offer2, offer3, offer4, offer5, offer6, offer7, offer8, offer9]

bid0 = {'bid_id': '24ea1cc1-811f-437e-a748-b8a0f00cd401', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 8, 00), 'end_time': datetime(2020, 6, 2, 12, 00), 'expire_time': datetime(2020, 6, 1, 1, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 20}
bid1 = {'bid_id': '6ee19822-d16e-4372-9f3d-5ae430237d30', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 10, 00), 'end_time': datetime(2020, 6, 2, 12, 00), 'expire_time': datetime(2020, 6, 1, 2, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 11}
bid2 = {'bid_id': '45930fdb-e591-406e-98fc-56ab7a87db24', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 12, 00), 'end_time': datetime(2020, 6, 2, 14, 00), 'expire_time': datetime(2020, 6, 1, 3, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 12}
bid3 = {'bid_id': '9c713b4d-fddb-4e99-ae3e-5c02aadec389', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 12, 00), 'end_time': datetime(2020, 6, 2, 16, 00), 'expire_time': datetime(2020, 6, 1, 4, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 13}
bid4 = {'bid_id': '2369d6ba-b841-4586-93c0-4d14571755ce', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 12, 00), 'end_time': datetime(2020, 6, 2, 18, 00), 'expire_time': datetime(2020, 6, 1, 5, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 14}
bid5 = {'bid_id': '38ec7b78-d330-47d4-94f4-b5f904895cd3', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 14, 00), 'end_time': datetime(2020, 6, 2, 16, 00), 'expire_time': datetime(2020, 6, 1, 6, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 15}
bid6 = {'bid_id': '4cccbeaf-3e60-4dcc-8a3d-eba41e91c5a9', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 12, 00), 'end_time': datetime(2020, 6, 2, 16, 00), 'expire_time': datetime(2020, 6, 1, 7, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 15}
bid7 = {'bid_id': '9ae99e29-092d-492c-8f58-e804f1f21685', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 16, 00), 'end_time': datetime(2020, 6, 2, 20, 00), 'expire_time': datetime(2020, 6, 1, 8, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 17}
bid8 = {'bid_id': 'fcf1b70f-3236-41a5-bf65-be26e3ed8d56', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 20, 00), 'end_time': datetime(2020, 6, 2, 23, 00), 'expire_time': datetime(2020, 6, 1, 9, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 10}
bid9 = {'bid_id': '0165c7d6-4e3d-4165-9c93-d423275a76bf', 'project_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'quantity': 1, 'start_time': datetime(2020, 6, 2, 20, 00), 'end_time': datetime(2020, 6, 2, 22, 00), 'expire_time': datetime(2020, 6, 1, 10, 00), 'duration': 16400, 'status': 'available', 'config_query': {'memory_gb': 10240, 'cpu_arch': 'x86_64', 'cpu_physical_count': 4, 'cpu_core_count': 16, 'cpu_ghz': 3}, 'cost': 10}

bids = [bid0, bid1, bid2, bid3, bid4, bid5, bid6, bid7, bid8, bid9]

provider0 = {'user_id': 'ab23f5d5-9718-4c8e-a499-0a79baac6484', 'username': 'provider0', 'role': 'provider', 'credit': 1000}
renter0 = {'user_id': 'ba0ee0fe-ee77-474e-8588-cf6a023c6c05', 'username': 'renter0', 'role': 'renter', 'credit': 1000}
users = [provider0, renter0]